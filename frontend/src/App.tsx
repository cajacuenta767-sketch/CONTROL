...
const I = {
  ...
  contabilidad: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="4" y="3" width="16" height="18" rx="2"/><path d="M8 7h8M8 11h8M8 15h5"/></svg>,
...
export function App() {
  ...
  const esSoporte = usuario.rol === 'soporte', esContador = usuario.rol === 'contador';
  type Enlace = { a: string; t: string; i: keyof typeof I };
  const grupos: { titulo?: string; enlaces: Enlace[] }[] = esSoporte ? [
    { enlaces: [{ a: '/', t: 'Panel', i: 'panel' }, { a: '/tickets', t: 'Soporte', i: 'tickets' }, { a: '/licencias', t: 'Licencias', i: 'licencias' }, { a: '/clientes', t: 'Clientes', i: 'clientes' }] },
    { titulo: 'Ayuda', enlaces: [{ a: '/precios', t: 'Lista de precios', i: 'precios' }, { a: '/guia', t: 'Cómo funciona', i: 'guia' }] },
  ] : esContador ? [
    { enlaces: [{ a: '/', t: 'Panel', i: 'panel' }, { a: '/ventas', t: 'Ventas', i: 'ventas' }, { a: '/clientes', t: 'Clientes', i: 'clientes' }] },
    { titulo: 'Dinero', enlaces: [{ a: '/caja', t: 'Caja', i: 'caja' }, { a: '/comisiones', t: 'Comisiones', i: 'comisiones' }, { a: '/reportes', t: 'Reportes', i: 'reportes' }, { a: '/contabilidad', t: 'Contabilidad', i: 'contabilidad' }] },
    { titulo: 'Ayuda', enlaces: [{ a: '/precios', t: 'Lista de precios', i: 'precios' }, { a: '/guia', t: 'Cómo funciona', i: 'guia' }] },
  ] : [
    ...
    { titulo: 'Dinero', enlaces: [{ a: '/precios', t: 'Lista de precios', i: 'precios' }, { a: '/caja', t: 'Caja', i: 'caja' }, { a: '/comisiones', t: esSuper ? 'Comisiones' : 'Mis comisiones', i: 'comisiones' }, { a: '/reportes', t: 'Reportes', i: 'reportes' }, { a: '/tablero', t: 'Tablero', i: 'tablero' }, ...(esSuper ? [{ a: '/contabilidad', t: 'Contabilidad', i: 'contabilidad' as const }] : [])] },
  ...
  const rolTexto = usuario.rol === 'superadmin' ? 'Superadministrador' : usuario.rol === 'admin' ? 'Administrador' : usuario.rol === 'revendedor' ? `Revendedor · cupo ${usuario.cupo_licencias ?? 0}` : esSoporte ? 'Soporte técnico' : esContador ? 'Contador' : `Vendedor · ${usuario.comision_pct}% comisión`;
      ...
      <main className="contenido" id="principal" tabIndex={-1}>
        ...
        <LimiteErrores>
          <Routes>
            ...
            {(esSuper || esContador) && <Route path="/contabilidad" element={<Contabilidad />} />}
