...
const TITULOS: [string, string][] = [
  ...
  ['/comisiones', 'Comisiones'], ['/reportes', 'Reportes'], ['/tickets', 'Tickets'], ['/seguridad', 'Mi seguridad'], ['/portal', 'Portal del cliente'], ['/catalogo', 'Catálogo'], ['/equipo', 'Equipo'], ['/auditoria', 'Auditoría'], ['/ajustes', 'Ajustes'], ['/login', 'Entrar'], ['/comprar', 'Comprar'], ['/pagar', 'Pagar'], ['/pedido', 'Mi pedido'],
];
...
export function App() {
  ...
  const grupos: { titulo?: string; enlaces: { a: string; t: string; i: keyof typeof I }[] }[] = [
    ...
    { titulo: 'Dinero', enlaces: [{ a: '/caja', t: 'Caja', i: 'caja' }, { a: '/comisiones', t: 'Comisiones', i: 'comisiones' }, { a: '/reportes', t: 'Reportes', i: 'reportes' }] },
