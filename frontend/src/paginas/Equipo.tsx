...
export function Equipo() {
  ...
  const campos = (v: any, set: (x: any) => void, conClave: boolean) => (
    <>
      ...
      <Campo etiqueta="Rol"><select value={v.rol} onChange={(e) => set({ ...v, rol: e.target.value })}><option value="vendedor">Vendedor</option><option value="revendedor">Revendedor externo</option><option value="admin">Administrador</option><option value="soporte">Soporte (tickets y licencias, sin ventas)</option><option value="contador">Contador (caja, comisiones y Excel, sin ventas)</option><option value="superadmin">Superadministrador</option></select></Campo>
      {v.rol === 'revendedor' && (
        <>
