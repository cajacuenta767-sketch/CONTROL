...
const SECCIONES: { titulo: string; descripcion?: string; campos: CampoDef[] }[] = [
  ...
  { titulo: 'Facturación', descripcion: 'Boletas y facturas electrónicas. Con Nubefact (Perú) se envían a SUNAT; con "manual" CONTROL solo numera y guarda el comprobante.', campos: [
    { clave: 'facturacion_proveedor', etiqueta: 'Proveedor', tipo: 'select', opciones: [['ninguno', 'Desactivada'], ['manual', 'Manual (numera y registra, sin envío)'], ['nubefact', 'Nubefact (SUNAT, Perú)']] },
    { clave: 'empresa_ruc', etiqueta: 'RUC de la agencia' },
    { clave: 'empresa_razon_social', etiqueta: 'Razón social' },
    { clave: 'empresa_direccion', etiqueta: 'Dirección fiscal' },
    { clave: 'serie_boleta', etiqueta: 'Serie de boletas', ayuda: 'Ej.: B001. La numeración la lleva CONTROL.' },
    { clave: 'serie_factura', etiqueta: 'Serie de facturas', ayuda: 'Ej.: F001' },
    { clave: 'igv_pct', etiqueta: 'IGV / IVA (%)', tipo: 'number' },
    { clave: 'precios_incluyen_igv', etiqueta: 'Los precios de lista ya incluyen el impuesto', tipo: 'select', opciones: [['1', 'Sí (se desglosa del total)'], ['0', 'No (se suma al total)']] },
    { clave: 'facturar_automatico', etiqueta: 'Emitir comprobante automáticamente al confirmar cada cobro', ayuda: 'Factura si el cliente tiene RUC; boleta en los demás casos.', tipo: 'select', opciones: [['0', 'No, lo emito a mano desde la venta'], ['1', 'Sí']] },
    { clave: 'nubefact_url', etiqueta: 'Nubefact · URL de la API', ayuda: 'La ruta que te da Nubefact para tu empresa (https://api.nubefact.com/api/v1/…).' },
    { clave: 'nubefact_token', etiqueta: 'Nubefact · token', tipo: 'password' },
  ] },
